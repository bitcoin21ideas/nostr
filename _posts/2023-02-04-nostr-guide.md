...
# Гид по созданию и настройке профиля Nostr
...
* **Bitcoin Lightning Tips:** Сюда вставляем ваш Lightning Address или LNURL адрес, который будет отображаться в профиле иконкой ⚡️ и на который смогут отправлять саты все желающие. Получить Lightning адрес можно, к примеру, на [getalby.com](https://getalby.com/) при создании аккаунта. К слову, если получить LN адрес в Alby, то вы одним выстрелом убьете 2х зайцев. Какой второй заяц? Читайте далее.

![LN-Temptation](https://nostr.build/i/nostr.build_46627ace49d1d10294739334d8a3737e239929009825724e5fecfa5a5de94fb9.jpg)

### *Не вставляйте туда ончейн-адреса или lightning инвойсы. Они не будут работать. После того как вы внесли адрес в графу, попробуйте отправить пару сатош самому себе через страницу профиля, чтобы убедиться, что всё работает.*
...
Ну а дальше все просто: вы вставляете в соответствующее (Настройка профиля) поле свой публичный ключ Nostr, а сайт подскажет вам, какой identifier нужно будет указать в профиле Nostr. У меня это almoo@lnmarkets.com.
